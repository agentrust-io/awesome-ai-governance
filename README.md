...
- [AI Control Tower](https://github.com/kironovlaziz-del/AI-tower#readme) - Open-source enterprise AI governance platform and LLM gateway providing PII masking (NER), Shadow AI monitoring, full MLOps lifecycle, and a manual kill-switch for incident response.
