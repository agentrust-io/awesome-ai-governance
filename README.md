...
- [Council of AI — GSPC](https://councilof.ai) - Independent AI-governance measurement (not certification). Living board **22 axis · 22 measured** via https://councilof.ai/api/gspc — quote `totals.public_count`. Of the 14 behavioural comparison axes: 1 statistically separated leader, 2 ties, 11 untested (a TIE is not a win). Methodology DOI [10.5281/zenodo.21991104](https://doi.org/10.5281/zenodo.21991104).
