...
- [CCS (Correctover Conformance Shape)](https://github.com/DSHCorrectover/ccs-verifier) - 7-dimension runtime verification standard (Structure/Schema/Latency/Cost/Identity/Integrity/Security) for agent tool calls. Framework-agnostic sidecar/proxy intercepts every tools/call at the network boundary, emitting Ed25519-signed, hash-chained receipts with 22 normative fields. Python e2e P50 ~27μs. Elastic License 2.0. [IETF Internet-Draft](https://datatracker.ietf.org/doc/draft-correctover-ccs/).
