...
- [Proofpane](https://github.com/Proofpane/releases) - Runtime governance proxy for AI agents and MCP clients with policy gates (allow/deny/human-in-the-loop), DLP redaction, cost caps, and a hash-chained audit log that exports as Ed25519-signed, offline-verifiable evidence.
